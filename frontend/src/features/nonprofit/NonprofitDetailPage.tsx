...
export function NonprofitDetailPage(): React.JSX.Element {
  ...
  return (
    <div className="page nonprofit-detail-page">
      <Link to="/nonprofits" className="ghost-button">
        ← Back to list
      </Link>

      <div className="nonprofit-detail-header">
        <Avatar src={mediaUrl(detail.logoUrl)} name={detail.orgName} size={72} />
        <div>
          <h1 style={{ margin: 0 }}>{detail.orgName}</h1>
      ...
      {detail.targetAmount != null && (
        <div className="nonprofit-detail-section">
          ...
          <div className="nonprofit-progress-bar">
            <span className="nonprofit-progress-bar-fill" style={{ transform: `scaleX(${raisedRatio})` }} />
          </div>
