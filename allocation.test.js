...
import { changeCategoryPercent, changeCharityShare, equalShares, allocationSummary, clampIncome } from './allocation.js';

test('simulated income stays within the amount accepted by the save API', () => {
  assert.equal(clampIncome(2e9), 1e9);
});
